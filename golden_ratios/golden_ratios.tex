...
\begin{align*}
    ...
    0 &= y^2-y-n \text{,}\quad n \in \mathbb{N}\text{,}\quad n\ne0\\
    \intertext{(When n is 0 the solutions are not irrational... and they are not "phi-esque", not like the golden ration)}\\
    \intertext{The solution to this quadratic is:}\\
    y&=\frac{1\pm\sqrt{1+4n}}{2}\\
    \intertext{I will show that for any nonzero natural number this solution is always irrational and I will show that this solution is the only soltuion to a certain set of peculiar equations... just like the golden ratio}\\
    \\
\end{align*}
